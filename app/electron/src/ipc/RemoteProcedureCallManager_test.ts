...
import { MainChannels, RemoteProcedureCallManager } from './RemoteProcedureCallManager';
...
describe('RemoteProcedureCallManager', () => {
    ...
    describe('Constructor', () => {
        ...
        it('Should subscribe to IPC events', () => {
            ...
            expect(fixture.mockIPC.Listen).toHaveBeenCalledWith(MainChannels.Stop, expect.anything());
            expect(fixture.mockIPC.Listen).toHaveBeenCalledWith(MainChannels.Restart, expect.anything());
        });
    });
});