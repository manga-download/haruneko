...
const translations: VariantResource = { // NOTE: Use defaults for missing translations
  ...
  Settings_Global_MediaDirectoryInfo: "HaruNeko'nun indirmeleri depolayacağı dizini seçin",
  Settings_Global_MediaDirectory_UnsetError: "HaruNeko ayarlarında indirme dizini seçilmedi!",
  ...
  Settings_Global_WebsiteSubDirectoryInfo: "HaruNeko'nun medyayı doğrudan dizinde mi depolayacağını yoksa web sitesi başına alt dizinler mi oluşturacağını ayarlayın",
  ...
  Settings_Global_UserAgentInfo: "HaruNeko'nun her web sitesi isteği için taklit edeceği Kullanıcı Aracısı (varsayılanı kullanmak için boş bırakın)",
  ...
  Settings_Global_RPCEnabledInfo: "HaruNeko uygulamasıyla uyumlu 3. taraf uygulamalar için erişimi etkinleştirin (örn. HaruNeko Assistant)",
  Settings_Global_RPCPort: "RPC Portu",
  Settings_Global_RPCPortInfo: "Bu HaruNeko uygulamasıyla etkileşim kurmak için uyumlu 3. taraf uygulamalar tarafından kullanılacak iletişim portu (örn. HaruNeko Assistant)",
  Settings_Global_RPCSecret: "RPC Şifresi",
  Settings_Global_RPCSecretInfo: "Uyumlu 3. taraf uygulamaların HaruNeko uygulamasıyla etkileşim kurması için gereken parola (örn. HaruNeko Assistant)",
  //
  Settings_FeatureFlags_Label: "Özellik Bayrakları",
  Settings_FeatureFlags_Description: "Özellikle HaruNeko geliştiricileri, katkıda bulunanlar ve uzman kullanıcılar için Gelişmiş/Deneysel seçenekler",
  ...
  FetchProvider_Fetch_CloudFlareChallenge: "\"{0}\" isteği, CloudFlare Anti-Bot tespiti tarafından reddedildi.\nBu web sitesinin içeriğine erişmeden önce CloudFlare engelini aştığınızdan emin olun (örneğin, HaruNeko Assistant tarayıcı uzantısını kullanarak).",
