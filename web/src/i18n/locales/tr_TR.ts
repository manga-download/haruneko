...
const translations: VariantResource = { // NOTE: Use defaults for missing translations
  ...
  Frontend_FluentCore_Settings_FeatureFlags_ShowSplashScreen_Label: "Açılış Ekranını Göster",
  Frontend_FluentCore_Settings_FeatureFlags_ShowSplashScreen_Description: "Uygulama başlarken açılış ekranını aç/kapat",
  Frontend_FluentCore_Settings_FeatureFlags_ShowFetchBrowserWindows_Label: "FetchBrowser Pencerelerini Göster",
  Frontend_FluentCore_Settings_FeatureFlags_ShowFetchBrowserWindows_Description: "Geliştiricilere özel bu seçenek, arka planda kullanılan verileri yakalamak için gereken tarayıcı pencerelerinin görünürlüğünü açar/kapatır",
  //
