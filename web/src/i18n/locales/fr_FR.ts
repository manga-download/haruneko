...
const translations: VariantResource = { // NOTE: Use defaults for missing translations
  ...
  Settings_Global_MediaDirectoryInfo: "Sélectionner le répertoire où HaruNeko stocke les téléchargements",
  Settings_Global_MediaDirectory_UnsetError: "Aucun répertoire de téléchargement sélectionné dans les paramètres de HaruNeko !",
  ...
  Settings_Global_WebsiteSubDirectoryInfo: "Définissez si HaruNeko doit stocker les médias directement dans le répertoire ou utiliser des sous-répertoires par site web",
  ...
  Settings_Global_UserAgentInfo: "L'agent utilisateur que HaruNeko prétendra être pour chaque demande de site web (laisser vide pour utiliser la valeur de défaut)",
  ...
  Settings_Global_RPCEnabledInfo: "Activer l'accès aux applications tierces compatibles à cette instance d'HaruNeko (par exemple, l'assistant HaruNeko)",
  Settings_Global_RPCPort: "Port RPC",
  Settings_Global_RPCPortInfo: "Le port de communication à utiliser par des applications tierces compatibles pour interagir avec cette instance d'HaruNeko (par exemple HaruNeko Assistant)",
  Settings_Global_RPCSecret: "Secret du RPC",
  Settings_Global_RPCSecretInfo: "Le mot de passe requis par les applications tierces compatibles pour interagir avec cette instance d'HaruNeko (par exemple, l'assistant HaruNeko)",
  //
  Settings_FeatureFlags_Label: "Indicateurs de fonctionnalités",
  Settings_FeatureFlags_Description: "Options avancées/expérimentales spécialement pour les développeurs, les contributeurs et les utilisateurs expérimentés d'HaruNeko",
  ...
  FetchProvider_Fetch_CloudFlareChallenge: "La demande adressée à \"{0}\" a été rejetée par la détection anti-bot de CloudFlare.\nVeillez à contourner CloudFlare avant d'accéder au contenu de ce site web (par exemple, avec l'extension de navigateur HaruNeko Assistant).",
  ...
  Plugin_Common_Image_MirroredDownloadError: "Impossible de télécharger l'image à partir de plusieurs serveurs : {0}",
