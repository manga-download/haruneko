...
const translations: VariantResource = { // NOTE: Use defaults for missing translations
  ...
  Frontend_Classic_Settings_SidenavIconsOnTop: "Icônes de menu en haut",
  Frontend_Classic_Settings_SidenavIconsOnTopInfo: "Les boutons d'accueil et de plugins apparaîtront en haut à la place de sidenav.",
  ...
  Frontend_FluentCore_Menu_ExportBookmarks_Label: "Exporter les signets…",
  Frontend_FluentCore_Menu_ExportBookmarks_Description: "Exporter tous les signets vers un fichier (par exemple, pour la sauvegarde)",
  //
  ...
  Settings_Global_MangaExportFormat: "Format de téléchargement des Manga/Comic",
  Settings_Global_MangaExportFormatInfo: "Le format du conteneur pour stocker le contenu téléchargé pour mangas/BD",
  ...
  Settings_Global_MangaExportFormat_PortableDocumentFormat: "Format de document portable (*.pdf)",
  ...
  Settings_Global_RPCEnabledInfo: "Activer l'accès aux applications tierces comaptibles pour cette instance HakuNeko (par exemple, l'assistant HakuNeko)",
  Settings_Global_RPCPort: "Port RPC",
  Settings_Global_RPCPortInfo: "Le port de communication à utiliser par des applications tierces compatibles pour interagir avec cette instance HakuNeko (par exemple HakuNeko Assistant)",
  Settings_Global_RPCSecret: 'RPC Secret',
  Settings_Global_RPCSecretInfo: "Le mot de passe requis par les applications tierces compatibles pour interagir avec cette instance HakuNeko (par exemple, l'assistant HakuNeko)",
  //
  Settings_FeatureFlags_Label: "Indicateurs de fonctionnalités",
  Settings_FeatureFlags_Description: "Options avancées/expérimentales spécialement pour les développeurs, les contributeurs et les utilisateurs expérimentés de HakuNeko",
  Settings_FeatureFlags_ShowSplashScreen_Label: "Montrer l'écran de démarrage",
  Settings_FeatureFlags_ShowSplashScreen_Description: "Activer/désactiver l'écran d'accueil lors du démarrage de l'application",
  Settings_FeatureFlags_ShowFetchBrowserWindows_Label: "Afficher la fenêtre FetchBrowser",
  ...
  Annotations_ViewProgressDescription: "Un état personnalisé indiquant la progression de la lecture ou de la visualisation",
  ...
  Annotations_ViewProgress_CurrentDescription: "Lecture/visualisation en cours",
  // [SECTION]: Trackers
  ...
  Plugin_Settings_UrlOverride: "Remplacement de l'URL",
  ...
  Plugin_CopyManga_Settings_GlobalCDN: "Utiliser CDN Global",
