...
const translations: IVariantResource = { // NOTE: Use defaults for missing translations
  ...
  Frontend_Product_Description: "Manga, Anime e Novel Downloader",
  ...
  Frontend_Media: "Mídia",
  Frontend_Medias: "Mídia",
  Frontend_Media_List: "Lista de mídia",
  Frontend_Media_Select: "Selecionar mídia",
  Frontend_Media_Selection: "Seleção de mídia",
