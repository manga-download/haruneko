...
const translations: VariantResource = { // NOTE: Use defaults for missing translations
  ...
  Settings_Global_MediaDirectoryInfo: "Selecione o diretório onde HaruNeko armazena os downloads",
  Settings_Global_MediaDirectory_UnsetError: "Nenhum diretório de download selecionado nas configurações de HaruNeko!",
  ...
  Settings_Global_WebsiteSubDirectoryInfo: "Definir se HaruNeko deve armazenar a mídia diretamente no diretório ou usar subdiretórios por site",
  ...
  Settings_Global_UserAgentInfo: "O User-Agent que HaruNeko será fingido ser para cada pedido do site (deixe em branco para usar o padrão)",
  ...
  Settings_Global_RPCEnabledInfo: "Habilitar acesso para aplicativos de terceiros comaptíveis para esta instância HaruNeko (por exemplo, Assistente HaruNeko)",
  Settings_Global_RPCPort: "Porta RPC",
  Settings_Global_RPCPortInfo: "A porta de comunicação para ser usada por aplicativos de terceiros compatíveis para interagir com esta instância de HaruNeko (por exemplo, Assistente de HaruNeko)",
  Settings_Global_RPCSecret: "Segredo RPC",
  Settings_Global_RPCSecretInfo: "A senha exigida por aplicativos de terceiros compatíveis para interagir com esta instância do HaruNeko (por exemplo, Assistente HaruNeko)",
  //
  Settings_FeatureFlags_Label: "Feature flag",
  Settings_FeatureFlags_Description: "Opções avançadas/experimentais especialmente para desenvolvedores HaruNeko, colaboradores e usuários avançados",
  ...
  FetchProvider_Fetch_CloudFlareChallenge: "O pedido para \"{0}\" foi rejeitado pela detecção do CloudFlare Anti-Bot.\nCertifique-se de ignorar a CloudFlare antes de acessar o conteúdo deste site (por exemplo, com a extensão de navegador assistente HaruNeko).",
