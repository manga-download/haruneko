...
const translations: VariantResource = { // NOTE: Use defaults for missing translations
  ...
  Frontend_FluentCore_Settings_FeatureFlags_ShowSplashScreen_Label: "Startbild anzeigen",
  Frontend_FluentCore_Settings_FeatureFlags_ShowSplashScreen_Description: "Schaltet das Startbild Fensters an/aus",
  Frontend_FluentCore_Settings_FeatureFlags_ShowFetchBrowserWindows_Label: "Zeige das versteckte Browser-Fenster",
  Frontend_FluentCore_Settings_FeatureFlags_ShowFetchBrowserWindows_Description: "Diese Entwickler-fokussierte Option schaltet die Sichtbarkeit des Browserfensters für das Abrufen von Daten im Hintergrund ein oder aus",
  //
