...
const translations: VariantResource = { // NOTE: Use defaults for missing translations
  ...
  Settings_Global_MediaDirectoryInfo: "Wählen Sie das Verzeichnis, in dem HaruNeko die heruntergeladenen Inhalte speichern soll",
  ...
  Settings_Global_WebsiteSubDirectoryInfo: "Legen Sie fest, ob HaruNeko Medien direkt im Verzeichnis speichern soll oder Unterverzeichnisse pro Website verwenden soll",
  ...
  Settings_Global_UserAgentInfo: "Der User-Agent Header den HaruNeko für alle Anfragen an die Webseiten verwendet (bei fehlender Eingabe wir der Standard Wert genutzt)",
  ...
  Settings_Global_RPCEnabledInfo: "Aktiviert den Zugriff auf HaruNeko durch Software von Drittanbietern (wie z.B. HaruNeko Assistant)",
  Settings_Global_RPCPort: 'RPC Port',
  Settings_Global_RPCPortInfo: "Die Port-Nummer für die Kommunikation zwischen HaruNeko und Drittanbieter Programmen (z.B. HaruNeko Assistant)",
  Settings_Global_RPCSecret: "RPC Schlüssel",
  Settings_Global_RPCSecretInfo: "Der Zugriffsschlüssel für die Kommunikation zwischen HaruNeko und Drittanbieter Programmen (z.B. HaruNeko Assistant)",
  //
  ...
  FetchProvider_Fetch_CloudFlareChallenge: "Die Anfrage an \"{0}\" wurde von der CloudFlare Anti-Bot Erkennung zurückgewiesen.\nStelle sicher, dass CloudFlare freigeschaltet wird bevor auf den Inhalt dieser Website zugegriffen wird (z.B. mit der HaruNeko Assistant Browser Erweiterung).",
