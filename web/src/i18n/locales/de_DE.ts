...
const translations: VariantResource = { // NOTE: Use defaults for missing translations
  ...
  Settings_FeatureFlags_ShowSplashScreen_Label: "Startbild anzeigen",
  Settings_FeatureFlags_ShowSplashScreen_Description: "Schaltet das Startbild Fensters an/aus",
  Settings_FeatureFlags_ShowFetchBrowserWindows_Label: "Zeige das versteckte Browser-Fenster",
