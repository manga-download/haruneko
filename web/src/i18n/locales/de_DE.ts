...
const translations: IVariantResource = { // NOTE: Use defaults for missing translations
  ...
  Frontend_FluentCore_MediaTitleSelect_UpdateEntriesButton_Description: "Klicken, um eine Liste aller verfügbaren \nKapitel/Episoden von der Webseite herunter zu laden, abhängig von der Anzahl der erforderlichen Anfragen kann der Vorgang eine längere Zeit in Anspruch nehmen",
