...
const translations: VariantResource = {
  ...
  Settings_Global_MediaDirectoryInfo: 'Select the directory where HaruNeko store the downloads',
  Settings_Global_MediaDirectory_UnsetError: 'No download directory selected in HaruNeko settings!',
  ...
  Settings_Global_WebsiteSubDirectoryInfo: 'Set wether HaruNeko shall store media directly in the directory, or use sub-directories per website',
  ...
  Settings_Global_UserAgentInfo: 'The User-Agent that HaruNeko will be pretend to be for each website request (leave blank to use default)',
  ...
  Settings_Global_RPCEnabledInfo: 'Enable access for comaptible 3rd-party applications to this HaruNeko instance (e.g., HaruNeko Assistant)',
  Settings_Global_RPCPort: 'RPC Port',
  Settings_Global_RPCPortInfo: 'The communication port to be used by compatible 3rd-party applications to interact with this HaruNeko instance (e.g., HaruNeko Assistant)',
  Settings_Global_RPCSecret: 'RPC Secret',
  Settings_Global_RPCSecretInfo: 'The passphrase required by compatible 3rd-party applications to interact with this HaruNeko instance (e.g., HaruNeko Assistant)',
  //
  Settings_FeatureFlags_Label: 'Feature Flags',
  Settings_FeatureFlags_Description: 'Advanced/Experimental options especially for HaruNeko developers, contributors and power users',
  ...
  FetchProvider_Fetch_CloudFlareChallenge: 'The request to "{0}" was rejected by CloudFlare Anti-Bot detection.\nMake sure to bypass CloudFlare before accessing the content of this website (e.g., with the HaruNeko Assistant browser extension).',
