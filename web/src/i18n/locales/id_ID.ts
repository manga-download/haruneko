...
const translations: IVariantResource = { // NOTE: Use defaults for missing translations
  ...
  FrontendController_Reload_ConfirmNotice: "Tampilan depan diubah. Restart sekarang untuk beralih ke tampilan baru?",
  ...
  Tags_Language_Multilingual: "🌐Multibahasa",
  Tags_Language_Arabic: "🇸🇦Arab",
  Tags_Language_Chinese: "🇨🇳China",
  Tags_Language_English: "🇬🇧Inggris",
  Tags_Language_French: "🇫🇷Prancis",
  Tags_Language_German: "🇩🇪Jerman",
  Tags_Language_Indonesian: "🇮🇩Indonesia",
  Tags_Language_Italian: "🇮🇹Italia",
  Tags_Language_Japanese: "🇯🇵Jepang",
  Tags_Language_Korean: "🇰🇷Korea",
  Tags_Language_Polish: "🇵🇱Polandia",
  Tags_Language_Portuguese: "🇵🇹🇧🇷Portugis",
  Tags_Language_Russian: "🇷🇺Russia",
  Tags_Language_Spanish: "🇪🇸🇦🇷Spanyol",
  Tags_Language_Thai: "🇹🇭Thailand",
  Tags_Language_Turkish: "🇹🇷Turki",
  Tags_Language_Vietnamese: "🇻🇳Vietnam",
  Tags_Others: "Lainnya",
  // [SECTION]: Trackers
