...
const translations: VariantResource = { // NOTE: Use defaults for missing translations
  ...
  Settings_Global_MediaDirectoryInfo: "Pilih direktori dimana HaruNeko menyimpan hasil unduhan",
  Settings_Global_MediaDirectory_UnsetError: "Tidak ada direktori unduhan yang dipilih dalam pengaturan HaruNeko!",
  ...
  Settings_Global_WebsiteSubDirectoryInfo: "Tetapkan apakah HaruNeko akan menyimpan media secara langsung di direktori, atau menggunakan subdirektori per situs web",
