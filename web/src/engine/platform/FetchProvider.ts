...
const instance = new PlatformInstanceActivator<FetchProvider>()
...
export const FetchCSS = instance.FetchCSS.bind(instance);
export const FetchHTML = instance.FetchHTML.bind(instance);
export const FetchJSON = instance.FetchJSON.bind(instance);
export const FetchRegex = instance.FetchRegex.bind(instance);
export const FetchProto = instance.FetchProto.bind(instance);
export const FetchGraphQL = instance.FetchGraphQL.bind(instance);
export const FetchWindowScript = instance.FetchWindowScript.bind(instance);
export const FetchWindowPreloadScript = instance.FetchWindowPreloadScript.bind(instance);
