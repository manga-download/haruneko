...
export default class extends Kosaku {
    ...
    public constructor() {
        super('inarimanga', 'InariManga', 'https://inarimanga.yofast.xyz', Tags.Media.Manhwa, Tags.Media.Manga, Tags.Language.Spanish, Tags.Source.Aggregator, Tags.Accessibility.DomainRotation);
    }
