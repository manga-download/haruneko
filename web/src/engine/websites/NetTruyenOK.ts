...
@Common.PagesSinglePageJS(`[...document.querySelectorAll('div.page-chapter > img:not([class])')].map(img => img.dataset.original ?? img.src);`, 750)
@Common.ImageAjax()
export default class extends DecoratableMangaScraper {

    public constructor() {
        super('nettruyen#A4F21DC2', 'NetTruyen OK', 'https://nettruyen12s.com', Tags.Media.Manhwa, Tags.Media.Manhua, Tags.Language.Vietnamese, Tags.Source.Aggregator);
    }
