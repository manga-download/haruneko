...
import icon from './NovaScans.webp';
...
export default class extends DecoratableMangaScraper {
    ...
    public constructor() {
        super('cosmicscansid', 'Nova Scans', 'https://novascans.id', Tags.Media.Manhwa, Tags.Media.Manhua, Tags.Language.Indonesian, Tags.Source.Scanlator);
    }
