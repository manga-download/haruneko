...
import icon from './ReadWebtoons.webp';
import { DecoratableMangaScraper } from '../providers/MangaPlugin';
import * as Madara from './decorators/WordPressMadara';
import * as Common from './decorators/Common';

@Madara.MangaCSS(/^https?:\/\/webtoonupdates\.com\/manga\/[^/]+\/$/)
...
export default class extends DecoratableMangaScraper {
    ...
    public constructor() {
        super('readwebtoons', 'WebtoonUpdates', 'https://webtoonupdates.com'/*, Tags.Media., Tags.Language.*/);
    }
...
// Original Source
/*
class ReadWebtoons extends WordPressMadara {
