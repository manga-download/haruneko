...
export default class extends Manatoki {
    ...
    public constructor() {
        super('newtoki', `NewToki`, 'https://newtoki469.com', [Tags.Media.Manga, Tags.Media.Manhwa, Tags.Language.Korean, Tags.Source.Aggregator, Tags.Accessibility.DomainRotation]);
