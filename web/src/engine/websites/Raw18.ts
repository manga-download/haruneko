...
export default class extends DecoratableMangaScraper {
    ...
    public constructor() {
        super('haremu18', 'Raw18', 'https://raw18.pics', Tags.Media.Manhwa, Tags.Media.Manga, Tags.Language.Japanese, Tags.Source.Aggregator, Tags.Rating.Pornographic, Tags.Accessibility.DomainRotation);
    }
