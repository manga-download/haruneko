...
@Common.MangaCSS(/^{origin}\/Comic\/ComicInfo\/id\/\d+$/i, '.works-intro-title')
...
@Common.ChaptersSinglePageCSS('.works-chapter-list.chapter-page-all li span.works-chapter-item a', undefined, undefined, true)
@Common.ImageAjax()
