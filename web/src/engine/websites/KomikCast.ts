...
@MangaStream.MangaCSS(/^https?:\/\/komikcast\.ch\/komik\/[^/]+\/$/, 'h1.komik_info-content-body-title')
...
@MangaStream.PagesSinglePageCSS([/999\.jpg/], 'div.main-reading-area img.lazyload, div.separator img.lazyload')
@Common.ImageAjax()
export default class extends DecoratableMangaScraper {

    public constructor() {
        super('komikcast', 'KomikCast', 'https://komikcast.ch', Tags.Media.Manga, Tags.Language.Indonesian);
    }
