...
@Common.MangasFromPathsCSS(['/series', '/series/oneshot', '/series/trial'], 'div.serial-contents ul.series-table-list > li.subpage-table-list-item > a', undefined, CoreView.DefaultMangaExtractor)
