...
import icon from './MangaRaw.webp';
import { DecoratableMangaScraper } from '../../providers/MangaPlugin';

export default class extends DecoratableMangaScraper {

    public constructor() {
        super('mangaraw', `MangaRaw (Manga Raw Club)`, 'https://www.manga-raw.club' /*, Tags.Language.English, Tags ... */);
    }
...
// Original Source
/*
class MangaRaw extends Connector {
