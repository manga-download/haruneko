...
@FoolSlide.MangaCSS(/^https?:\/\/seinagi\.org\.es\/online\/series\/[^/]+\/?$/, 'div.comic h1.title')
...
export default class extends DecoratableMangaScraper {
    ...
    public constructor() {
        super('seinagifansub-es', `SeinagiFansub (ES)`, 'https://seinagi.org.es', Tags.Language.Spanish, Tags.Source.Scanlator, Tags.Media.Manga);
    }
