...
import icon from './ComicClear.webp';
import { DecoratableMangaScraper } from '../../providers/MangaPlugin';

export default class extends DecoratableMangaScraper {

    public constructor() {
        super('comicclear', `コミッククリア (Comic Clear)`, 'https://www.comic-clear.jp' /*, Tags.Language.English, Tags ... */);
    }
...
// Original Source
/*
class ComicClear extends Connector {
