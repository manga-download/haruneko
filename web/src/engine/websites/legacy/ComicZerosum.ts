...
export default class extends DecoratableMangaScraper {
    ...
    public override async FetchManga(provider: MangaPlugin, url: string): Promise<Manga> {
        ...
        const data = await FetchProto<APISingleTitle>(request, this.protoTypes, responseType);
    ...
    public override async FetchMangas(provider: MangaPlugin): Promise<Manga[]> {
        ...
        const data = await FetchProto<APITitles>(request, this.protoTypes, responseType);
    ...
    public override async FetchChapters(manga: Manga): Promise<Chapter[]> {
        ...
        const responseType = 'ComicZerosum.TitleView';
        const request = new FetchRequest(uri.href);
        const data = await FetchProto<TitleView>(request, this.protoTypes, responseType);
    ...
    public override async FetchPages(chapter: Chapter): Promise<Page[]> {
        ...
        const data = await FetchProto<APIPages>(request, this.protoTypes, responseType);
