...
import icon from './HatsukiManga.webp';
import { DecoratableMangaScraper } from '../../providers/MangaPlugin';

export default class extends DecoratableMangaScraper {

    public constructor() {
        super('hatsukimanga', `Hatsuki Manga`, 'https://hatsukimanga.com' /*, Tags.Language.English, Tags ... */);
    }
...
// Original Source
/*
class HatsukiManga extends Connector {
