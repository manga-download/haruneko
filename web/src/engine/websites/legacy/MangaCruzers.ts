...
import icon from './MangaCruzers.webp';
import { DecoratableMangaScraper } from '../../providers/MangaPlugin';

export default class extends DecoratableMangaScraper {

    public constructor() {
        super('mangacruzers', `MangaCruzers`, 'https://mangacruzers.com' /*, Tags.Language.English, Tags ... */);
    }
...
// Original Source
/*
class MangaCruzers extends Connector {
