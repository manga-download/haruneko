...
export default class extends DecoratableMangaScraper {
    ...
    public override async FetchMangas(provider: MangaPlugin): Promise<Manga[]> {
        ...
        const mangas = await Common.FetchMangasFromPathsCSS.call(this, provider, ['/oneshot', '/newcomer', '/daysneo'], 'div.yomikiri-container ul.yomikiri-items > li.yomikiri-item-box > a.yomikiri-link', undefined, MangaExtractor);
