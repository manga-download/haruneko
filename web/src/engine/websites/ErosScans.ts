...
@MangaStream.MangaCSS(/^https:\/\/(erosxcomic|erosmanga)\.xyz\/manga\/[^/]+\/$/)
...
export default class extends DecoratableMangaScraper {
    ...
    public constructor() {
        super('erosscans', 'Eros Scans', 'https://erosmanga.xyz', Tags.Media.Manhwa, Tags.Media.Manhua, Tags.Language.English, Tags.Source.Scanlator, Tags.Accessibility.DomainRotation);
    }
