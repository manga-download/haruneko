...
@MangaStream.MangaCSS(/^https:\/\/(erosxcomic|erosmanga|doomcomic)\.xyz\/manga\/[^/]+\/$/)
...
export default class extends DecoratableMangaScraper {
    ...
    public constructor() {
        super('erosscans', 'Eros Scans', 'https://doomcomic.xyz', Tags.Media.Manhwa, Tags.Media.Manhua, Tags.Language.English, Tags.Source.Scanlator, Tags.Accessibility.DomainRotation);
    }
