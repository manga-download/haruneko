...
export default class extends DecoratableMangaScraper {
    ...
    public override async FetchMangas(provider: MangaPlugin) : Promise<Manga[]> {
        ...
        const request = new FetchRequest(new URL('changeMangaList?type=text', this.URI).href);
    ...
    async changeLanguage(language) {
        await FetchWindowScript(new FetchRequest(this.URI.href), ''); //necessary cause /lang redirect to last viewed manga
