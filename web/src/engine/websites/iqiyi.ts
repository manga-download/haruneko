...
export default class extends DecoratableMangaScraper {
    ...
    public override async FetchChapters(manga: Manga): Promise<Chapter[]> {
        ...
        return data.data.episodes.map(element => new Chapter(this, manga, `/manhua/reader/${manhuaId}_${element.episodeId}.html`, [element.episodeOrder,element.episodeTitle.trim()].join(" ")));
    }
