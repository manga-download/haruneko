...
export default class extends DecoratableMangaScraper {
    ...
    public constructor() {
        super('dualeotruyen', 'DuaLeoTruyen', 'https://dualeotruyengl.com', Tags.Media.Manhwa, Tags.Media.Manhua, Tags.Media.Manga, Tags.Language.Vietnamese, Tags.Source.Aggregator, Tags.Accessibility.DomainRotation);
    }
