...
export default class extends DecoratableMangaScraper {
    ...
    public constructor() {
        super('truyenqq', 'TruyenQQ', 'https://truyenqqgo.com', Tags.Media.Manhwa, Tags.Media.Manhua, Tags.Language.Vietnamese, Tags.Source.Aggregator);
    ...
    public override async FetchMangas(provider: MangaPlugin): Promise<Manga[]> {
        ...
        for (let page = 1, run = true; run; page += 1) {
            const mangas = await this.interactionTaskPool.Add(async () => Common.FetchMangasSinglePagesCSS.call(this, provider, [ `/truyen-moi-cap-nhat/trang-${page}.html` ], 'ul.list_grid li h3 a'), Priority.Low);
