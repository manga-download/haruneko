...
export default class extends DecoratableMangaScraper {
    ...
    public constructor() {
        super('jmanga', 'JManga', 'https://ww1.jmanga.one', Tags.Media.Manhua, Tags.Media.Manhwa, Tags.Language.Japanese, Tags.Source.Aggregator, Tags.Accessibility.DomainRotation);
    }
