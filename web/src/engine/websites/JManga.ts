...
export default class extends DecoratableMangaScraper {
    ...
    public constructor() {
        super('jmanga', 'JManga', 'https://jmanga.mom', Tags.Media.Manhua, Tags.Media.Manhwa, Tags.Language.Japanese, Tags.Source.Aggregator, Tags.Accessibility.DomainRotation);
    }
