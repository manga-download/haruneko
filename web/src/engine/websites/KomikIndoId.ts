...
export default class extends DecoratableMangaScraper {
    ...
    public constructor() {
        super('komikindoid', 'KomikIndoId', 'https://komikindo.org', Tags.Media.Manga, Tags.Language.Indonesian, Tags.Source.Aggregator, Tags.Accessibility.RegionLocked, Tags.Accessibility.DomainRotation);
    }
