...
@Common.MangaCSS(/^https:\/\/(lector|visor)ikigai\.\w+\.(net|com|xyz|online|org)\/series\/[^/]+\/$/, 'article > img', (element: HTMLImageElement) => element.alt.trim())
...
export default class extends DecoratableMangaScraper {
    ...
    public constructor() {
        super('ikigaimangas', 'Ikigai Mangas', 'https://lectorikigai.vrinari.org', Tags.Media.Manhwa, Tags.Media.Manhua, Tags.Language.Spanish, Tags.Source.Aggregator, Tags.Accessibility.DomainRotation);
    }
