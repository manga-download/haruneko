...
@Common.MangaCSS(/^https?:\/\/23\.mintmanga\.live\/[^/]+$/, ReadM.queryMangaTitle)
...
export default class extends DecoratableMangaScraper {
    public constructor() {
        super('mintmanga', `MintManga`, 'https://23.mintmanga.live', Tags.Language.Russian, Tags.Media.Manga, Tags.Media.Manhua, Tags.Media.Manhwa, Tags.Source.Aggregator);
    }
