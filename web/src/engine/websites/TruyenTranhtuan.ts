...
export default class extends DecoratableMangaScraper {
    ...
    public constructor() {
        super('truyentranhtuan', 'TruyenTranhtuan', 'https://truyentranhtuan.xyz', Tags.Media.Manga, Tags.Media.Manhua, Tags.Media.Manhwa, Tags.Language.Vietnamese, Tags.Source.Aggregator);
    }
