     ...
     new Promise(async (resolve, reject) => {
         try {
             ...
             debugger;
                 ...
                 {
                     mode = 'puzzle';
                     blocks = window.NFBR.a6G.a5x.prototype.i9j(fPage, fPage.width, fPage.height);
                 }
...
export default class extends DecoratableMangaScraper {
    ...
    public constructor() {
        super('dbookdocomo', `Dbook Docomo`, 'https://dbook.docomo.ne.jp' /*, Tags.Language.English, Tags ... */);
    }
