...
export default class extends DecoratableMangaScraper {
    ...
    public constructor() {
        super('lectormangalat', 'LectorManga (.Lat)', 'https://lector-mangas.lat', Tags.Media.Manga, Tags.Media.Manhwa, Tags.Media.Manhua, Tags.Language.Spanish, Tags.Source.Aggregator, Tags.Rating.Pornographic);
    }
