...
export default class extends DecoratableMangaScraper {
    ...
    public constructor() {
        super('lectormangalat', 'LectorManga (.Lat)', 'https://lectormangaas.com', Tags.Media.Manga, Tags.Media.Manhwa, Tags.Media.Manhua, Tags.Language.Spanish, Tags.Source.Aggregator, Tags.Rating.Pornographic);
    }
