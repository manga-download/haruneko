...
export class MangaPlugin extends MediaContainer<Manga> {
    ...
    public async Update(): Promise<void> {
        await this.Initialize();
        this._entries = await this.scraper.GetUniqueMediaItems<Manga>(await this.scraper.FetchMangas(this));
...
export class Manga extends MediaContainer<Chapter> {
    ...
    public async Update(): Promise<void> {
        await this.Initialize();
        this._entries = await this.scraper.GetUniqueMediaItems<Chapter>(await this.scraper.FetchChapters(this));
    }
}
