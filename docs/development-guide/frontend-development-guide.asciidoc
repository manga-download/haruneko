...
[NOTE]
Due to a link:https://github.com/lit/lit/issues/2716[bug] it might be required to set `useDefineForClassFields: false` in `tsconfig.json` for correct link:https://github.com/microsoft/TypeScript/issues/48814[field decorator handling].
