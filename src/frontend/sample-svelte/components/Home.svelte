...
<div id="container">
    ...
    <div>
        ...
        <div class="border">
            <p><strong>HakuNeko</strong> is not hosting anything. Find a website on the internet that provides the content you want. Then :
            <ol>
            ...
            <p>The connector you are looking for is not in the list ?<br/>
        ...
        <h4>Ready to go 🚀</h4>
        <div class="border"><p>Download, view, bookmark your favorite mangas 📚</p></div>
    </div>
</div>