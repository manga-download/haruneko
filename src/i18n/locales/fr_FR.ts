...
export const en_US: IVariantResource = {
  ...
  FrontendController_Reload_ConfirmNotice: "Le frontend a été changé. Redémarrez maintenant pour passer à la nouvelle interface?",
  // [SECTION]: Frontend (Common/Shared)
  Frontend_Product_Title: 'HakuNeko',
  Frontend_Product_Description: "Manga, Anime et Nouveau téléchargeur",
