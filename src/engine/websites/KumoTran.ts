...
@Madara.MangaCSS(/^https?:\/\/www\.kumotran\.com\/manga\/[^/]+\/$/)
...
export default class extends DecoratableMangaScraper {
    ...
    public constructor() {
        super('kumotran', 'KumoTran', 'https://www.kumotran.com'/*, Tags.Media., Tags.Language.*/);
    }
...
// Original Source
/*
class KumoTran extends WordPressMadara {
