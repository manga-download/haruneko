...
import icon from './CrunchyManga.webp';
import { DecoratableMangaScraper } from '../../providers/MangaPlugin';

export default class extends DecoratableMangaScraper {

    public constructor() {
        super('crunchymanga', `Crunchyroll* (Manga)`, 'https://www.crunchyroll.com' /*, Tags.Language.English, Tags ... */);
    }
...
// Original Source
/*
class CrunchyManga extends Crunchyroll {
