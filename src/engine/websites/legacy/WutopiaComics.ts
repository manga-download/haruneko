...
import icon from './WutopiaComics.webp';
import { DecoratableMangaScraper } from '../../providers/MangaPlugin';

export default class extends DecoratableMangaScraper {

    public constructor() {
        super('wutopiacomics', `Wutopia`, 'https://www.wutopiacomics.com' /*, Tags.Language.English, Tags ... */);
    }
...
// Original Source
/*
class WutopiaComics extends Connector {
