...
import icon from './JumpBookStore.webp';
import { DecoratableMangaScraper } from '../../providers/MangaPlugin';

export default class extends DecoratableMangaScraper {

    public constructor() {
        super('jumpbookstore', `ジャンプBOOKストア (Jump Book Store)`, 'https://jumpbookstore.com' /*, Tags.Language.English, Tags ... */);
    }
...
// Original Source
/*
class JumpBookStore extends Publus {
