...
import icon from './ComicBunch.webp';
import { DecoratableMangaScraper } from '../../providers/MangaPlugin';

export default class extends DecoratableMangaScraper {

    public constructor() {
        super('comicbunch', `コミックバンチ (ComicBunch)`, 'https://www.comicbunch.com' /*, Tags.Language.English, Tags ... */);
    }
...
// Original Source
/*
class ComicBunch extends Connector {
