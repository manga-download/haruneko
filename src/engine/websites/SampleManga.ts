...
export default class extends MediaContainer implements IMangaHost {
    ...
    public async GetPages(chapter: IChapter): Promise<IPage[]> {
        return [
            new Page('https://raw.githubusercontent.com/manga-download/haruneko/master/sample/MangaBySheep/Chapter1/Page01.png', chapter),
            new Page('https://raw.githubusercontent.com/manga-download/haruneko/master/sample/MangaBySheep/Chapter1/Page02.png', chapter),
            new Page('https://raw.githubusercontent.com/manga-download/haruneko/master/sample/MangaBySheep/Chapter1/Page03.png', chapter),
            new Page('https://raw.githubusercontent.com/manga-download/haruneko/master/sample/MangaBySheep/Chapter1/Page04.png', chapter),
            new Page('https://raw.githubusercontent.com/manga-download/haruneko/master/sample/MangaBySheep/Chapter1/Page05.png', chapter),
        ];
    }
}